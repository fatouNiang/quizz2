...
<div class="col-sm-6 d-flex ml-auto text-center justify-content-end barre" id="formAdd">
    ...
    <form id="form" method="post" enctype="multipart/form-data">
        ...
        <div class="choise2">
            ...
            <input id="file" type="file" class="input-file" accept="image/*" name="image" onchange="loadFile(event)" required> 
        </div>
...
$(document).ready(function () {
    ...
    $('#form').submit(function(){
        ...
        //  }else{
            ...
            $.ajax({
                type:"POST",
                url:'./traitement/Add_admin.php',
                data: avatar,
                processData: false,
                contentType: false,
                dataType:'text',
                success: function (data){
                    console.log('sa marche pour le moment');
                    console.log(data);
                    // if(data){
                        $("#prenom").val('');
                         $("#nom").val('');
                        ...
                        $("#pwd2").val('');
                        $("#file").val('');
                    //     $('#formAdd').load("pages/listeAdmin.php");
                    // }
                }
            })
